...
namespace Lab5_Bai04
{
    public partial class main : Form
    {
        ...
        private List<string> dishesInfo = new List<string>();
        ...
        private async Task RequestDishesList(string url, int currentPage, int pageSize)
        {
            ...
            if (responses.IsSuccessStatusCode)
            {
                ...
                foreach (var monAn in responseObject.Data)
                {
                    ...
                    dishesInfo.Add(monan + "," + gia + "," + diachi + "," + nguoidonggop + "," + imgurl);
        ...
        private void randomBtn_Click(object sender, EventArgs e)
        {
            ...
            if (list.Count > 0)
            {
                ...
                control = list[idx];
                dishInfo = dishesInfo[idx];
            }

            if (control != null)
            {
                show_random_dish form = new show_random_dish(control, dishInfo);
                form.ShowDialog();
            }
            else
            {
